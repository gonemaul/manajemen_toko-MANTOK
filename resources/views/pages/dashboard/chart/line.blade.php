<div class="chart-container">
    <canvas id="revenueChart" width="705" height="193" style="margin-top: 10px"></canvas>
</div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            initChart();
            $('#yearPengeluaran').on('change', function() {
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            title: function() {
                                return 'Pengeluaran'; // Menghilangkan judul (bulan tidak ditampilkan)
                            },
        ...
        const myLineChart = new Chart(ctx, pengeluaranChart);
        // const initChart = async () => {
        //     $.ajax({
        //         url: '',
        //         type: 'GET',
        //         data: {
        //             year: $('#yearPengeluaran').val()
        //         },
        //         success: function(response) {
        //             if (response.data) {
        //                 myLineChart.data = response.data.data;
        //                 myLineChart.options.scales.y.ticks.max = response.data.maxValue;
        //                 myLineChart.options.scales.y.ticks.stepSize = response.data.maxValue / 5;
        //                 myLineChart.update();
